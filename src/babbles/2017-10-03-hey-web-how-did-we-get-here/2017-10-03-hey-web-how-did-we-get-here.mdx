...
<BabbleImage
  src={installingImage}
  alt="XKCD installing comic"
  style="float: right; max-width: 13rem; margin: 2em 0 2em 2em"
  data-invert-on-dark
  data-monochrome-blend
/>
