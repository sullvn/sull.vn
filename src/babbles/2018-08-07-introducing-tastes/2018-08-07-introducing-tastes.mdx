...
import faceBoxesImage from './face-boxes.png';
import facesConversationImage from './faces-conversation.png';
import dragonLoveImage from './dragon-love.jpg';

<img src={faceBoxesImage.src} />
...
<img src={facesConversationImage.src} data-invert-on-dark />
