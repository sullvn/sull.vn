---
slug: introducing-tastes
date: '2018-08-08T18:08:01.385Z'
title: 'Introducing Tastes and Rapid Prototyping with Flavor'
description: 'Introducing Tastes, a TypeScript library for intelligent sample generation. Quickly explore design variations while creatively prototyping.'
---

import BabbleImage from '../../components/BabbleImage.astro';
import facesConversationImage from './faces-conversation.png';

![Face boxes](./face-boxes.png)
...
<BabbleImage src={facesConversationImage} alt="Faces conversation" data-invert-on-dark />
