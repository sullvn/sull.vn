---
slug: could-we-code-with-lunchables
date: "2017-11-02T06:30:20.829Z"
title: "Could We Code with Lunchables?"
description: "What kids' lunches can teach us about composable software."
---

import BabbleImage from '../../components/BabbleImage.astro';
import lunchableClosedImage from './lunchable-closed.png';
import lunchableOpenImage from './lunchable-open.png';
...
<BabbleImage src={lunchableClosedImage} alt="Lunchable closed" data-invert-on-dark />
...
<BabbleImage src={lunchableOpenImage} alt="Lunchable open" data-invert-on-dark />
