...
<Image src={introSpelunkerImage} alt="Intro spelunker" layout="constrained" width={150} data-invert-on-dark />
...
<Image src={randomSamplingImage} alt="Random sampling" layout="constrained" width={368} data-invert-on-dark />
...
<Image src={shannonNyquistSamplingImage} alt="Shannon Nyquist sampling" layout="constrained" width={368} data-invert-on-dark />
...
<Image src={snakeCurvesImage} alt="Snake curves" data-invert-on-dark />
...
<Image src={hilbertMappingImage} alt="Hilbert mapping" layout="constrained" width={300} />
