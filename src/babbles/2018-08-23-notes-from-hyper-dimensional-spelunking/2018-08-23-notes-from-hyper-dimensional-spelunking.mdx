...
description: 'Notes on sampling high-dimensional spaces to visualize program behavior.'
---
...
<BabbleImage src={introSpelunkerImage} alt="Intro spelunker" data-invert-on-dark />
...
<BabbleImage src={randomSamplingImage} alt="Random sampling" data-invert-on-dark />
...
<BabbleImage src={shannonNyquistSamplingImage} alt="Shannon Nyquist sampling" data-invert-on-dark />
...
![Hilbert mapping](./hilbert-mapping.png)
